...
function ab(a) {
 ...
 do if (a >>> 0 < 245) {
  ...
  if (b & 3 | 0) {
   ...
   h = d + 8 | 0;
   e = c[h >> 2] | 0;
   do if ((g | 0) == (e | 0)) c[909] = k & ~(1 << f); else {
    if (e >>> 0 < (c[913] | 0) >>> 0) ka();
    a = e + 12 | 0;
    if ((c[a >> 2] | 0) == (d | 0)) {
     c[a >> 2] = g;
  ...
  if (q >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (h | 0) {
     ...
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[913] | 0) >>> 0) ka(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (h >>> 0 < ((c[911] | 0) - q | 0) >>> 0) {
    ...
    do if (h >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (a >>> 0 < (c[913] | 0) >>> 0) ka(); else {
      c[a >> 2] = j;
      c[j + 24 >> 2] = d;
      c[j + 12 >> 2] = j;
      c[j + 8 >> 2] = j;
  ...
  do if (!k) {
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (k | 0)) {
     ...
     if ((w | 0) == 276) if (a >>> 0 < (c[913] | 0) >>> 0) ka(); else {
      c[a >> 2] = l;
      c[l + 24 >> 2] = d;
      c[l + 12 >> 2] = l;
      c[l + 8 >> 2] = l;
   ...
   if ((d | 0) != (k | 0)) {
    ...
    if ((w | 0) == 302) if (a >>> 0 < (c[913] | 0) >>> 0) ka(); else {
     c[a >> 2] = k;
     c[k + 24 >> 2] = d;
     c[k + 12 >> 2] = k;
     c[k + 8 >> 2] = k;
...
function Qa(e, f, g, j, l) {
 ...
 a : while (1) {
  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
     ...
     if ((D | 0) == 97) {
      ...
      p = q + w | 0;
      Xa(e, 32, K, p, I);
      if (!(c[e >> 2] & 32)) Ra(y, w, e) | 0;
      Xa(e, 48, K, p, I ^ 65536);
      o = f - ca | 0;
      if (!(c[e >> 2] & 32)) Ra(V, o, e) | 0;
      f = $ - t | 0;
      Xa(e, 48, q - (o + f) | 0, 0, 0);
      if (!(c[e >> 2] & 32)) Ra(v, f, e) | 0;
      Xa(e, 32, K, p, I ^ 8192);
      f = (p | 0) < (K | 0) ? K : p;
      break;
     }
     ...
     if ((o | 0) > 0) {
      ...
      while (1) {
       ...
       do if (q >>> 0 < s >>> 0) q = s; else {
        o = 0;
        do {
         B = hb(c[q >> 2] | 0, 0, t | 0) | 0;
         B = eb(B | 0, C | 0, o | 0, 0) | 0;
         o = C;
     ...
     do if (t) {
      ...
      if ((f | 0) > 0 & o >>> 0 < z >>> 0) {
       ...
       while (1) {
        ...
        if (!(c[e >> 2] & 32)) Ra(o, (f | 0) > 9 ? 9 : f, e) | 0;
        p = p + 4 | 0;
        o = f + -9 | 0;
        if (!((f | 0) > 9 & p >>> 0 < z >>> 0)) {
         f = o;
      ...
      if ((f | 0) > -1) {
       ...
       do {
        ...
        p = ba - o | 0;
        if (!(c[e >> 2] & 32)) Ra(o, (f | 0) > (p | 0) ? p : f, e) | 0;
        f = f - p | 0;
        q = q + 4 | 0;
       } while (q >>> 0 < t >>> 0 & (f | 0) > -1);
      }
     ...
     if (!(f & 32)) Ra(s ? (t ? 3576 : 3580) : t ? 3568 : 3572, 3, e) | 0;
     Xa(e, 32, K, q, I ^ 8192);
     f = (q | 0) < (K | 0) ? K : q;
    } while (0);
    o = f;
  ...
  o = (K | 0) < (q | 0) ? q : K;
  Xa(e, 32, o, q, p);
  if (!(c[e >> 2] & 32)) Ra(v, w, e) | 0;
  Xa(e, 48, o, q, p ^ 65536);
  Xa(e, 48, s, t, 0);
  if (!(c[e >> 2] & 32)) Ra(f, t, e) | 0;
  Xa(e, 32, o, q, p ^ 8192);
  z = J;
 }
...
function bb(a) {
 ...
 do if (!(a & d)) {
  ...
  if ((b | 0) == 127) if (a >>> 0 < (c[913] | 0) >>> 0) ka(); else {
   c[a >> 2] = q;
   c[q + 24 >> 2] = d;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
...
function Ea(b, d) {
 ...
 do {
  ...
  h = (k | 0) % 255 | 0;
  f = (k | 0) % 15 | 0;
  d = ((k | 0) % 120 | 0 | 0) % 1024 | 0;
  e = ((k | 0) % 1024 | 0) + k | 0;
  g = ((g | 0) % 1024 | 0) + g | 0;
  f = ((f | 0) % 1024 | 0) + f | 0;
  d = ((((h | 0) % 1024 | 0) + h + d | 0) % 1024 | 0) + d | 0;
  h = 0;
  do {
   r = h << 1;
   t = (h | 0) % 120 | 0;
   p = (r | 0) % 1024 | 0;
   o = (h + j | 0) % 1024 | 0;
   q = ((h | 0) % 255 | 0 | 0) % 1024 | 0;
   u = (h | 0) % 1024 | 0;
   s = ((h | 0) % 15 | 0 | 0) % 1024 | 0;
   b = (((d + u + s + q + p + o + ((f + u | 0) % 1024 | 0) + ((((t | 0) % 1024 | 0) + t + s | 0) % 1024 | 0) + ((p + r + q | 0) % 1024 | 0) + ((g + p | 0) % 1024 | 0) + ((e + o | 0) % 1024 | 0) | 0) % 100 | 0) + b | 0) % 10240 | 0;
   h = h + 1 | 0;
  } while ((h | 0) != 5e4);
  k = k + 1 | 0;
 } while ((k | 0) < (l | 0));
...
function Pa(b, d, e) {
 ...
 c[n >> 2] = c[e >> 2];
 if ((Qa(0, d, n, q, r) | 0) < 0) e = -1; else {
  if ((c[b + 76 >> 2] | 0) > -1) o = _a(b) | 0; else o = 0;
  e = c[b >> 2] | 0;
  m = e & 32;
...
function ob(a, b, d, e) {
 ...
 a = db(h ^ a | 0, g ^ b | 0, h | 0, g | 0) | 0;
 b = C;
 sb(a, b, db(l ^ d | 0, k ^ e | 0, l | 0, k | 0) | 0, C, j) | 0;
 e = db(c[j >> 2] ^ h | 0, c[j + 4 >> 2] ^ g | 0, h | 0, g | 0) | 0;
 d = C;
 i = f;
 return (C = d, e) | 0;
}
...
function nb(a, b, c, d) {
 ...
 h = db(j ^ a | 0, i ^ b | 0, j | 0, i | 0) | 0;
 g = C;
 a = f ^ j;
 b = e ^ i;
 return db((sb(h, g, db(f ^ c | 0, e ^ d | 0, f | 0, e | 0) | 0, C, 0) | 0) ^ a | 0, C ^ b | 0, a | 0, b | 0) | 0;
}
...
function Ya(a, b) {
 a = a | 0;
 b = b | 0;
 if (!a) a = 0; else a = Za(a, b, 0) | 0;
 return a | 0;
}

function Ha() {
 var a = 0;
 if (!0) a = 3632; else a = c[(jb() | 0) + 64 >> 2] | 0;
 return a | 0;
}
function va(a) {
 a = a | 0;
