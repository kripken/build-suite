...
function ab(a) {
 ...
 do if (a >>> 0 < 245) {
  ...
  if (b & 3 | 0) {
   ...
   h = d + 8 | 0;
   e = c[h >> 2] | 0;
   do if ((g | 0) == (e | 0)) c[910] = k & ~(1 << f); else {
    if (e >>> 0 < (c[914] | 0) >>> 0) ka();
    a = e + 12 | 0;
    if ((c[a >> 2] | 0) == (d | 0)) {
     c[a >> 2] = g;
  ...
  if (q >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (h | 0) {
     ...
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[914] | 0) >>> 0) ka(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (h >>> 0 < ((c[912] | 0) - q | 0) >>> 0) {
    ...
    do if (h >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (a >>> 0 < (c[914] | 0) >>> 0) ka(); else {
      c[a >> 2] = j;
      c[j + 24 >> 2] = d;
      c[j + 12 >> 2] = j;
      c[j + 8 >> 2] = j;
  ...
  do if (!k) {
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (k | 0)) {
     ...
     if ((w | 0) == 276) if (a >>> 0 < (c[914] | 0) >>> 0) ka(); else {
      c[a >> 2] = l;
      c[l + 24 >> 2] = d;
      c[l + 12 >> 2] = l;
      c[l + 8 >> 2] = l;
   ...
   if ((d | 0) != (k | 0)) {
    ...
    if ((w | 0) == 302) if (a >>> 0 < (c[914] | 0) >>> 0) ka(); else {
     c[a >> 2] = k;
     c[k + 24 >> 2] = d;
     c[k + 12 >> 2] = k;
     c[k + 8 >> 2] = k;
  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
     ...
     if (!(f & 32)) Ra(s ? (t ? 3579 : 3583) : t ? 3571 : 3575, 3, e) | 0;
     Xa(e, 32, K, q, I ^ 8192);
     f = (q | 0) < (K | 0) ? K : q;
    } while (0);
    o = f;
...
function bb(a) {
 ...
 do if (!(a & d)) {
  ...
  if ((b | 0) == 127) if (a >>> 0 < (c[914] | 0) >>> 0) ka(); else {
   c[a >> 2] = q;
   c[q + 24 >> 2] = d;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
...
function Ha() {
 var a = 0;
 if (!0) a = 3636; else a = c[(jb() | 0) + 64 >> 2] | 0;
 return a | 0;
}
function va(a) {
 a = a | 0;
