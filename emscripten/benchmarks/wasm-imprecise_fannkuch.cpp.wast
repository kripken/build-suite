(module
  ...
  (export "_i64Subtract" $hb)
  (export "_free" $fb)
  (export "_main" $Fa)
  (export "_i64Add" $ib)
  (export "_pthread_self" $nb)
  (export "_memset" $jb)
  (export "_malloc" $eb)
  (export "_memcpy" $mb)
  (export "_bitshift64Lshr" $kb)
  (export "___errno_location" $Ia)
  (export "_bitshift64Shl" $lb)
  ...
  (export "dynCall_ii" $xb)
  (export "dynCall_iiii" $yb)
  (export "dynCall_vi" $zb)
  (table $Ab $Ga $Bb $Na $Ka $La $Cb $Ma)
  ...
  (func $wb (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32) (result i32)
    (local $i i32)
    (local $g i32)
    (local $n i32)
    (local $k i32)
  ...
  (func $bb (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $g i32)
    (local $f i32)
    (if
  ...
  (func $sb (param $a i32) (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $h i32)
    (local $g i32)
    (local $j i32)
    (local $l i32)
  ...
  (func $ab (param $b i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (local $h i32)
    (local $j i32)
  ...
  (func $pb (param $b i32) (result i32)
    (local $c i32)
    (set_local $c
      (i32.load8_s
        (i32.add
  ...
  (func $vb (param $a i32) (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (set_local $g
      (i32.load
  ...
  (func $hb (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (set_local $d
      (i32.sub
        (i32.sub
          (get_local $b)
  ...
  (func $zb (param $a i32) (param $b i32)
