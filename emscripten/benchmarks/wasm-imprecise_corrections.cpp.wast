(module
  ...
  (export "_i64Subtract" $db)
  (export "_free" $bb)
  (export "_main" $Ea)
  (export "_i64Add" $eb)
  (export "_pthread_self" $jb)
  (export "_memset" $fb)
  (export "_malloc" $ab)
  (export "_memcpy" $ib)
  (export "_bitshift64Lshr" $gb)
  (export "___errno_location" $Ha)
  (export "_bitshift64Shl" $hb)
  (export "runPostSets" $cb)
  ...
  (export "dynCall_ii" $tb)
  (export "dynCall_iiii" $ub)
  (export "dynCall_vi" $vb)
  (table $wb $Fa $xb $Ma $Ja $Ka $yb $La)
  ...
  (func $Qa (param $e i32) (param $f i32) (param $g i32) (param $j i32) (param $l i32) (result i32)
    (local $o i32)
    (local $q i32)
    (local $p i32)
    (local $s i32)
  ...
  (func $sb (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32) (result i32)
    (local $i i32)
    (local $g i32)
    (local $n i32)
    (local $k i32)
  ...
  (func $Ta (param $a i32) (param $b i32) (param $d i32)
    (local $e i32)
    (local $f i32)
    (local $g f64)
    (block $label$break$a
  ...
  (func $Ea (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $m i32)
    (local $f i32)
    (local $h i32)
  ...
  (func $Wa (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $i i32)
    (local $f i32)
    (local $h i32)
    (local $g i32)
  ...
  (func $Xa (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32)
    (local $g i32)
    (local $h i32)
    (local $j i32)
    (set_local $j
  ...
  (func $Ua (param $b i32) (param $c i32) (param $d i32) (result i32)
    (local $e i32)
    (if
      (i32.or
        (i32.gt_u
  ...
  (func $Sa (param $b i32) (result i32)
    (local $d i32)
    (local $e i32)
    (set_local $d
      (i32.add
  ...
  (func $Ja (param $a i32) (param $b i32) (param $d i32) (result i32)
    (local $g i32)
    (local $f i32)
    (local $e i32)
    (set_local $f
  ...
  (func $mb (param $a i32) (param $b i32) (result i32)
    (local $e i32)
    (local $f i32)
    (local $d i32)
    (local $c i32)
  ...
  (func $kb (param $a i32) (param $b i32) (param $c i32) (result i32)
    (if
      (i32.lt_s
        (get_local $c)
        (i32.const 32)
  ...
  (func $gb (param $a i32) (param $b i32) (param $c i32) (result i32)
    (if
      (i32.lt_s
        (get_local $c)
        (i32.const 32)
  ...
  (func $db (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (set_local $d
      (i32.sub
        (i32.sub
          (get_local $b)
  ...
  (func $$a (param $a i32) (param $b i32) (result i32)
    (local $e i32)
    (local $d i32)
    (set_local $d
      (i32.load
  ...
  (func $Fa (param $a i32) (result i32)
    (local $d i32)
    (local $b i32)
    (set_local $b
      (i32.load
  ...
  (func $ub (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (return
      (call_indirect $FUNCSIG$iiii
        (i32.add
          (i32.and
  ...
  (func $vb (param $a i32) (param $b i32)
