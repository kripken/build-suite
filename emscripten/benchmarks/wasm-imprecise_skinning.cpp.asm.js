...
function pb(a) {
 ...
 do if (a >>> 0 < 245) {
  ...
  if (b & 3 | 0) {
   ...
   h = d + 8 | 0;
   e = c[h >> 2] | 0;
   do if ((g | 0) == (e | 0)) c[994] = k & ~(1 << f); else {
    if (e >>> 0 < (c[998] | 0) >>> 0) oa();
    a = e + 12 | 0;
    if ((c[a >> 2] | 0) == (d | 0)) {
     c[a >> 2] = g;
  ...
  if (q >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (h | 0) {
     ...
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[998] | 0) >>> 0) oa(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (h >>> 0 < ((c[996] | 0) - q | 0) >>> 0) {
    ...
    do if (h >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (a >>> 0 < (c[998] | 0) >>> 0) oa(); else {
      c[a >> 2] = j;
      c[j + 24 >> 2] = d;
      c[j + 12 >> 2] = j;
      c[j + 8 >> 2] = j;
 ...
 if ((w | 0) == 191) {
  a = (c[1102] | 0) + h | 0;
  c[1102] = a;
  if (a >>> 0 > (c[1103] | 0) >>> 0) c[1103] = a;
  k = c[1e3] | 0;
  do if (!k) {
   C = c[998] | 0;
   if ((C | 0) == 0 | f >>> 0 < C >>> 0) c[998] = f;
   c[1106] = f;
   c[1107] = h;
   c[1109] = 0;
   c[1003] = c[1112];
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (k | 0)) {
     ...
     if ((w | 0) == 276) if (a >>> 0 < (c[998] | 0) >>> 0) oa(); else {
      c[a >> 2] = l;
      c[l + 24 >> 2] = d;
      c[l + 12 >> 2] = l;
      c[l + 8 >> 2] = l;
   ...
   if ((d | 0) != (k | 0)) {
    ...
    if ((w | 0) == 302) if (a >>> 0 < (c[998] | 0) >>> 0) oa(); else {
     c[a >> 2] = k;
     c[k + 24 >> 2] = d;
     c[k + 12 >> 2] = k;
     c[k + 8 >> 2] = k;
  ...
  case 101:
   {
    ...
    do if (F >>> 0 < 2146435072 | (F | 0) == 2146435072 & 0 < 0) {
     ...
     if ((o | 0) > 0) {
      ...
      while (1) {
       ...
       do if (q >>> 0 < s >>> 0) q = s; else {
        o = 0;
        do {
         B = Ub(c[q >> 2] | 0, 0, t | 0) | 0;
         B = Rb(B | 0, C | 0, o | 0, 0) | 0;
         o = C;
         A = cc(B | 0, o | 0, 1e9, 0) | 0;
         c[q >> 2] = A;
         o = bc(B | 0, o | 0, 1e9, 0) | 0;
         q = q + -4 | 0;
        } while (q >>> 0 >= s >>> 0);
        if (!o) {
         q = s;
     ...
     if (!(f & 32)) eb(s ? (t ? 3757 : 3761) : t ? 3749 : 3753, 3, e) | 0;
     kb(e, 32, K, q, I ^ 8192);
     f = (q | 0) < (K | 0) ? K : q;
    } while (0);
    o = f;
...
function qb(a) {
 ...
 do if (!(a & d)) {
  ...
  if ((b | 0) == 127) if (a >>> 0 < (c[998] | 0) >>> 0) oa(); else {
   c[a >> 2] = q;
   c[q + 24 >> 2] = d;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
...
function dc(a, b, d, e, f) {
 ...
 if (!h) {
  ...
  do {
   ...
   e = a << 1 | e >>> 31 | 0;
   n = a >>> 31 | b << 1 | 0;
   Qb(k | 0, d | 0, e | 0, n | 0) | 0;
   p = C;
   o = p >> 31 | ((p | 0) < 0 ? -1 : 0) << 1;
   i = o & 1;
   a = Qb(e | 0, n | 0, o & m | 0, (((p | 0) < 0 ? -1 : 0) >> 31 | ((p | 0) < 0 ? -1 : 0) << 1) & l | 0) | 0;
   b = C;
   h = h - 1 | 0;
  } while ((h | 0) != 0);
  k = j;
...
function Sa(a, b, d, e, f) {
 ...
 e = e | 0;
 f = f | 0;
 var h = Ba, i = 0, j = Ba, k = Ba, l = Ba, m = Ba, n = Ba, o = Ba, p = Ba, q = Ba, r = Ba, s = Ba, t = Ba, u = 0, v = Ba, w = Ba, x = Ba;
 if (!b) return;
 while (1) {
  b = b + -1 | 0;
  i = c[e >> 2] | 0;
  j = ba(g[e + 4 >> 2]);
  k = ba(j * ba(g[a + (i * 48 | 0) >> 2]));
  h = ba(j * ba(g[a + (i * 48 | 0) + 4 >> 2]));
  m = ba(j * ba(g[a + (i * 48 | 0) + 8 >> 2]));
  o = ba(j * ba(g[a + (i * 48 | 0) + 12 >> 2]));
  q = ba(j * ba(g[a + (i * 48 | 0) + 16 >> 2]));
  s = ba(j * ba(g[a + (i * 48 | 0) + 20 >> 2]));
  t = ba(j * ba(g[a + (i * 48 | 0) + 24 >> 2]));
  r = ba(j * ba(g[a + (i * 48 | 0) + 28 >> 2]));
  p = ba(j * ba(g[a + (i * 48 | 0) + 32 >> 2]));
  n = ba(j * ba(g[a + (i * 48 | 0) + 36 >> 2]));
  l = ba(j * ba(g[a + (i * 48 | 0) + 40 >> 2]));
  j = ba(j * ba(g[a + (i * 48 | 0) + 44 >> 2]));
  i = e + 12 | 0;
  if (!(c[e + 8 >> 2] | 0)) while (1) {
   u = c[i >> 2] | 0;
   v = ba(g[e + 16 >> 2]);
   k = ba(k + ba(v * ba(g[a + (u * 48 | 0) >> 2])));
   h = ba(h + ba(v * ba(g[a + (u * 48 | 0) + 4 >> 2])));
   m = ba(m + ba(v * ba(g[a + (u * 48 | 0) + 8 >> 2])));
   o = ba(o + ba(v * ba(g[a + (u * 48 | 0) + 12 >> 2])));
   q = ba(q + ba(v * ba(g[a + (u * 48 | 0) + 16 >> 2])));
   s = ba(s + ba(v * ba(g[a + (u * 48 | 0) + 20 >> 2])));
   t = ba(t + ba(v * ba(g[a + (u * 48 | 0) + 24 >> 2])));
   r = ba(r + ba(v * ba(g[a + (u * 48 | 0) + 28 >> 2])));
   p = ba(p + ba(v * ba(g[a + (u * 48 | 0) + 32 >> 2])));
   n = ba(n + ba(v * ba(g[a + (u * 48 | 0) + 36 >> 2])));
   l = ba(l + ba(v * ba(g[a + (u * 48 | 0) + 40 >> 2])));
   j = ba(j + ba(v * ba(g[a + (u * 48 | 0) + 44 >> 2])));
   e = i + 12 | 0;
   if (!(c[i + 8 >> 2] | 0)) {
    u = i;
    i = e;
  ...
  v = ba(v + ba(h * x));
  w = ba(g[d + 8 >> 2]);
  g[f >> 2] = ba(o + ba(v + ba(m * w)));
  v = ba(g[d >> 2]);
  g[f + 4 >> 2] = ba(r + ba(ba(t * w) + ba(ba(s * x) + ba(q * v))));
  v = ba(p * v);
  g[f + 8 >> 2] = ba(j + ba(ba(l * w) + ba(v + ba(n * ba(g[i >> 2])))));
  i = d + 16 | 0;
  v = ba(k * ba(g[i >> 2]));
  u = d + 20 | 0;
  o = ba(g[u >> 2]);
  v = ba(v + ba(h * o));
  r = ba(g[d + 24 >> 2]);
  g[f + 16 >> 2] = ba(v + ba(m * r));
  v = ba(g[i >> 2]);
  g[f + 20 >> 2] = ba(ba(t * r) + ba(ba(s * o) + ba(q * v)));
  v = ba(p * v);
  g[f + 24 >> 2] = ba(ba(l * r) + ba(v + ba(n * ba(g[u >> 2]))));
  if (!b) break; else {
   f = f + 32 | 0;
   d = d + 32 | 0;
  }
...
function Ta(b, d) {
 b = b | 0;
 d = d | 0;
 var e = Ba, f = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = Ba;
 q = i;
 i = i + 64 | 0;
 p = q + 8 | 0;
 f = q;
 ...
 do {
  r = ba(g[f + (b << 4) >> 2]);
  r = ba(r + ba(g[f + (b << 4) + 4 >> 2]));
  r = ba(r + ba(g[f + (b << 4) + 8 >> 2]));
  e = ba(e + ba(r + ba(g[f + (b << 4) + 12 >> 2])));
  b = b + 1 | 0;
 } while ((b | 0) != (k | 0));
 h[p >> 3] = +e;
 ob(1332, p) | 0;
...
function $b(a, b, d, e) {
 ...
 a = Qb(h ^ a | 0, g ^ b | 0, h | 0, g | 0) | 0;
 b = C;
 dc(a, b, Qb(l ^ d | 0, k ^ e | 0, l | 0, k | 0) | 0, C, j) | 0;
 e = Qb(c[j >> 2] ^ h | 0, c[j + 4 >> 2] ^ g | 0, h | 0, g | 0) | 0;
 d = C;
 i = f;
 return (C = d, e) | 0;
}
...
function _b(a, b, c, d) {
 ...
 h = Qb(j ^ a | 0, i ^ b | 0, j | 0, i | 0) | 0;
 g = C;
 a = f ^ j;
 b = e ^ i;
 return Qb((dc(h, g, Qb(f ^ c | 0, e ^ d | 0, f | 0, e | 0) | 0, C, 0) | 0) ^ a | 0, C ^ b | 0, a | 0, b | 0) | 0;
}
...
function zb(a, b, d, e, f, g) {
 ...
 f = f | 0;
 g = g | 0;
 if ((a | 0) == (c[b + 8 >> 2] | 0)) Ab(0, b, d, e, f); else {
  a = c[a + 8 >> 2] | 0;
...
function Cb(a, b, d, e) {
 ...
 d = d | 0;
 e = e | 0;
 if ((a | 0) == (c[b + 8 >> 2] | 0)) Db(0, b, d, e); else {
  a = c[a + 8 >> 2] | 0;
...
function Wa() {
 var a = 0;
 if (!0) a = 3972; else a = c[(Wb() | 0) + 64 >> 2] | 0;
 return a | 0;
}
function Ja(a) {
 a = a | 0;
...
// EMSCRIPTEN_END_FUNCS
 ...
 var Ca = [ lc, $a, Ya, xb, Za, lc, lc, lc ];
 var Da = [ mc, Gb, Bb, mc ];
 var Ea = [ nc, rb, Eb, vb, wb, tb, Ib, Kb, _a, nc, nc, nc, nc, nc, nc, nc ];
 var Fa = [ oc, Ua, Lb, oc ];
 var Ga = [ pc ];
 var Ha = [ qc, Fb, zb, qc ];
 var Ia = [ rc, Hb, Cb, rc ];
